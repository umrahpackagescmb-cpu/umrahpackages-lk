...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/islamic-tools/women-umrah-guide", priority: 0.6, changeFrequency: "monthly" },
  { path: "/islamic-tools/hajj-guide", priority: 0.6, changeFrequency: "monthly" },
  { path: "/islamic-tools/wudu-guide", priority: 0.6, changeFrequency: "monthly" },
  { path: "/islamic-tools/salah-guide", priority: 0.6, changeFrequency: "monthly" },
  { path: "/islamic-tools/prayer-tracker", priority: 0.5, changeFrequency: "monthly" },
  { path: "/islamic-tools/islamic-quiz", priority: 0.5, changeFrequency: "monthly" },
